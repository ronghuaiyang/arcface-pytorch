...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=1000, init_weights=True, input_shape=(3, 224, 224)):
        super(VGG, self).__init__()
        self.features = features
        feature_size = self.get_conv_output(input_shape)
        # print feature_size
